...
Please use the [dedicated form](https://github.com/cosmic-plus/js-tx-params/issues/new/choose).

## Pull Requests

1. Fork [js-tx-params](https://github.com/cosmic-plus/js-tx-params).
...
```
git clone https://github.com/cosmic-plus/js-tx-params
cd js-tx-params
npm run get
```
